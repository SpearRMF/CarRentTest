                        ...
                        <div className="col-lg-8"> 
                            <div className="row row-cols-lg-3 row-cols-md-3"> 
                                <div className="pb-3 pt-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65 65" xmlSpace="preserve" fill-rule="evenodd" clip-rule="evenodd" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="2" stroke="currentColor" width="5rem" height="5rem" className="mb-3 text-primary">
